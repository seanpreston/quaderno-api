...
```shell
curl -u user:pass -X GET 'https://quadernoapp.com/my-account/api/v1/contacts.json'
```
...
curl -u user:pass 
	 ...
	 'https://quadernoapp.com/my-account/api/v1/contacts.json'
```
...
```shell
curl -u token-id:foo 'https://quadernoapp.com/my-account/api/v1/contacts'
```     
...
```shell
curl -u token_id:foo 'https://quadernoapp.com/my-account/api/v1/ping.json'
```
## Errors
