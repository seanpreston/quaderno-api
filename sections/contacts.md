...
If you've connected **Quaderno and Stripe**, you can also use `GET /stripe/customers/STRIPE_CUSTOMER_ID.json` to get the Quaderno contact for a Stripe customer.
