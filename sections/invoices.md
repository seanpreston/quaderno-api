...
This will return `201 Created`, with the current JSON representation of the invoice if the creation was a successthe along the location of the new invoice in the 'url' field .  If the user does not have access to create new invoices, you'll see `401 Unauthorized`.
